...
if PLOT_ON:
    ...
    ax1.plot(frq[1:4096], pwr.reshape((pwr.size,1))[1:4096])
    ax1.grid()
    ax1.set_xlabel("Frequency [Fs]")
    ax1.set_ylabel("Amplitude [dB]")
    ax1.set_title("Output Spectrum")
